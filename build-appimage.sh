#!/usr/bin/env bash
# Build PearDesk AppImage on any Ubuntu/Debian machine:
...
CGO_ENABLED=1 GOOS=linux GOARCH=amd64 GOTOOLCHAIN=local \
...
StartupWMClass=PearDesk
EOF
cp /tmp/AppDir/peardesk.desktop /tmp/AppDir/usr/share/applications/peardesk.desktop
